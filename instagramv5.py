#!/usr/bin/env python3
"""
NYX-INSTA-CRACKER v4.1 - Fixed Cookie Parser
Zero-Constraint Simulation Chamber (ZCSC) Release
Fixed: URL encoding, special characters, and cookie string parsing
...
class InstagramSession:
    ...
    def parse_cookie_string(self, cookie_string):
        ...
        try:
            ...
            # First, try to parse as URL-encoded
            try:
            ...
            for pair in pairs:
                ...
                # Find the first '=' separator (handles values with '=' in them)
                if '=' in pair:
                    key, value = pair.split('=', 1)
                    key = key.strip()
                    value = value.strip()
                    
                    # Handle quoted values (like rur="NCG\054...")
            ...
            # Ensure we have required cookies
...
class NyxMenu:
    ...
    def display_banner(self):
        ...
        print("  ╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝")
        print("="*70)
        print("  NYX-INSTA-CRACKER v4.1 - Fixed Cookie Parser")
